...
public class StmtCondition implements Comparable<StmtCondition> {
...
//	    public StringPathCondition spc = new StringPathCondition(this);
		...
		public StmtCondition make_copy() {
			StmtCondition pc_new = new StmtCondition();
...
//		mixed real/integer constraints to handle cast bytecodes
	   ...
	   /**
		...
		public String stringPC() {
			return "constraint # = " + count + ((header == null) ? " True" : "\n" + header.stringPC());
		}
		...
		public boolean equals(Object obj) {
			StmtCondition p = (StmtCondition) obj;
			if (count != p.count) {
				return false;
			}
			Constraint c = header;
		 ...
		 */
		@Override
		public int compareTo(StmtCondition pc) {
			int hc1 = hashCode();
			int hc2 = pc.hashCode();
			if (hc1 < hc2) {
				return -1;
